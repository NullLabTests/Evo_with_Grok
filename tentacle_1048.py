...
def tentacle(statement):
    ...
    # If the statement is not in the list, attempt to evaluate it as a mathematical expression
    try:
        result = eval(statement.replace("implies", "->").replace("and", "and").replace("or", "or").replace("not", "not"))
        return bool(result)
    except:
...
if __name__ == "__main__":
    ...
    print(tentacle('False implies True'))  # Should print: True