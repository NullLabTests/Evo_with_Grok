...
def tentacle(statement):
    ...
    This function evaluates the given logical statement against a set of known
    logical equivalences. It also supports basic mathematical expression evaluation
    ...
    Returns:
    bool or str: True if the statement is logically valid, False if invalid, or a string
                 result if the input is a mathematical expression.
