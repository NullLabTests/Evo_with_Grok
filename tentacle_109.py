...
def tentacle(statement):
    ...
    with the evaluation of logical statements. It checks if the given statement
    matches known logical equivalences and also evaluates simple mathematical
    ...
    Returns:
    str: 'True' if the statement is logically valid or the mathematical expression is correct,
         'False' otherwise. If the statement contains a mathematical expression, it returns
...
if __name__ == "__main__":
    ...
    print(tentacle('2 * 3 == 7'))  # Should print: False