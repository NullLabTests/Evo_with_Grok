...
def tentacle(statement):
    ...
    This function evaluates logical statements by comparing them to a set of known logical
    equivalences. It also supports evaluating simple mathematical expressions within the statements.

    Args:
    statement (str): A string containing a logical statement or a mathematical expression.

    Returns:
    bool or str: True if the statement is logically valid, False otherwise. If the input is a
                 mathematical expression, it returns the result as a string.
