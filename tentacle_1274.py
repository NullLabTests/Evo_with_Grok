...
def tentacle(statement):
    ...
    # If the statement is not in the predefined list, attempt to evaluate it
    try:
...
if __name__ == "__main__":
    ...
    print(tentacle('A implies B and B implies C'))  # Should print: True (if A=True, B=True, C=True)