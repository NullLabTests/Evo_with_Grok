...
def tentacle(expression):
    ...
    if lowered_expression in logical_equivalences:
        return 'True'
    elif any(equivalence in lowered_expression for equivalence in logical_equivalences):
        return 'True'
    else:
        try:
...
if __name__ == "__main__":
    ...
    print(tentacle('2 / 0'))  # Should print: Error: ZeroDivisionError: division by zero