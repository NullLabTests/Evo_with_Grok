...
def tentacle(expression):
    ...
    if lowered_expression.startswith('if') and lowered_expression.endswith('.'):
        return str(lowered_expression in logical_equivalences)
    
    # If not a logical statement, evaluate as a mathematical expression
    try:
