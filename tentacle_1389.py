...
def tentacle(statement):
    ...
    Returns:
    bool: True if the statement is logically valid or the expression evaluates to a non-zero number, False otherwise.
    ...
    try:
        ...
        # Return True if the result is truthy (non-zero, non-empty, etc.), False otherwise
        return bool(result)
    except Exception:
...
if __name__ == "__main__":
    ...
    print(tentacle('3 * 5'))  # Should print: True
