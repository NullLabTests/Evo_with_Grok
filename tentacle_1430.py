...
def tentacle(statement):
    ...
    Returns:
    bool or str: True if the statement is logically valid, False if it's not, or a string result if it's a mathematical expression.
...
if __name__ == "__main__":
    ...
    print(tentacle('x = 5'))  # Should print: False (not a valid logical statement or mathematical expression)