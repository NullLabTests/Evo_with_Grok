...
def tentacle(statement):
    ...
    equivalences = {
        ...
        "if a and b, then a.": True,
        "if a and b, then b.": True,
        "if a implies b, then a or b.": True,
        "if a implies b, then not a or b.": True,
    }
...
if __name__ == "__main__":
    ...
    print(tentacle('If A implies B, then not A or B.'))  # Should print: True
