...
def tentacle(statement):
    ...
    str: An error message if the statement cannot be processed.
...
if __name__ == "__main__":
    ...
    print(tentacle('A and B'))  # Should print: False (assuming A and B are False)
    print(tentacle('A or B'))  # Should print: False (assuming A and B are False)
    print(tentacle('Invalid statement'))  # Should print: Error message