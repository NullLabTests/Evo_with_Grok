...
def tentacle(statement):
    ...
    is logically valid, False otherwise. It also handles simple mathematical
    ...
    try:
        # Split the statement into left and right parts if it contains '=='
        if '==' in statement:
            ...
            # Evaluate the entire statement if it's a simple expression
...
if __name__ == "__main__":
    ...
    print(tentacle('2 * 3'))  # Should print: True (because 6 is truthy)
    print(tentacle('2 - 3'))  # Should print: False (because -1 is falsy)