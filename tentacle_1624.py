...
def tentacle(statement):
    ...
    This function evaluates logical statements by comparing them to a set of known logical equivalences.
    ...
    Returns:
    bool or str: True if the statement is logically valid, False if invalid, or a string result for mathematical expressions.
...
if __name__ == "__main__":
    ...
    print(tentacle('x = 5; x * 2'))  # Should print: '10'
