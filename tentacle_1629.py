...
def tentacle(statement):
    ...
    This function evaluates logical statements and checks if they are valid based on
    a set of known logical equivalences. It also supports basic mathematical operations
    ...
    try:
        ...
        statement = statement.replace("implies", "->").replace("and", "and").replace("or", "or").replace("not", "not")
