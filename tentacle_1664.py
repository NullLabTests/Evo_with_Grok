...
def tentacle(statement):
    ...
    It also supports simple mathematical expressions within the statements.
...
if __name__ == "__main__":
    ...
    print(tentacle('x = 5'))  # Should print: False (assignment is not a valid expression for evaluation)