...
def tentacle(statement):
    ...
    try:
        ...
        expression = expression.replace("is equivalent to", "==").replace("if", "").replace("then", "")
        
        # Evaluate the expression
        result = eval(expression, {"__builtins__": None}, {"->": lambda a, b: (not a) or b})
...
if __name__ == "__main__":
    ...
    print(tentacle('A or B implies C'))  # Should print: False
    print(tentacle('not A and B implies C'))  # Should print: False