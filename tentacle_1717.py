...
def tentacle(statement):
    ...
    It also allows for the evaluation of simple mathematical expressions within the logical statements.

    Args:
    statement (str): A string containing a logical statement or a mathematical expression.

    Returns:
    bool: True if the statement is logically valid or the mathematical expression evaluates to a truthy value, False otherwise.
