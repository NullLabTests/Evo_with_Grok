...
def tentacle(statement):
    ...
    This function checks if the given statement matches any of the known logical equivalences.
    It also evaluates simple mathematical expressions within the statement.
    
    Args:
    statement (str): A string containing a logical statement or mathematical expression.
    
    Returns:
    bool or str: True if the statement is logically valid, False if not, or the result of a mathematical expression as a string.
