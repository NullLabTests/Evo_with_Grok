...
def tentacle(statement):
    ...
    a set of known logical equivalences. It also handles basic mathematical
    ...
    try:
        ...
        if '==' in statement:
            ...
            # Evaluate the entire statement as a boolean expression
...
if __name__ == "__main__":
    ...
    print(tentacle('3 * 5 == 14'))  # Should print: False
    print(tentacle('5 > 3'))  # Should print: True
