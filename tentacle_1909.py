...
def tentacle(statement):
    ...
    This function evaluates logical statements and checks them against a set of known
    logical equivalences. It also supports evaluating simple mathematical expressions
