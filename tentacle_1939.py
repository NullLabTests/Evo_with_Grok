...
def tentacle(statement):
    ...
    This function evaluates logical statements by comparing them to known logical
    equivalences. It also supports basic mathematical expressions within the statement.
    ...
    try:
        ...
        # If evaluation fails, consider the statement false
        return False
...
if __name__ == "__main__":
    ...
    print(tentacle('sin(0) == 0'))  # Should print: True
    print(tentacle('unknown_function()'))  # Should print: False