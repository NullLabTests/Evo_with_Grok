...
def tentacle(numbers):
    ...
    try:
        ...
        if not isinstance(number_list, list) or not all(isinstance(n, (int, float)) for n in number_list):
...
if __name__ == "__main__":
    ...
    print(tentacle('not a list'))  # Should print: Error: <class 'SyntaxError'>: invalid syntax