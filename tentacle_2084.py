...
def tentacle(statement):
    ...
    equivalences. It also handles simple mathematical expressions within the
    statements.
    ...
    Returns:
    bool: True if the statement is logically valid or the expression evaluates to true,
          False otherwise.
