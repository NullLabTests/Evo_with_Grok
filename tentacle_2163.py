...
def tentacle(statement):
    ...
    This function evaluates the truth of logical statements by comparing them
    to a set of known logical equivalences. It also handles basic mathematical
...
if __name__ == "__main__":
    ...
    print(tentacle('2 + 2'))  # Should print: True (because 4 is truthy)
    print(tentacle('0'))  # Should print: False (because 0 is falsy)