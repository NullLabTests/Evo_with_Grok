...
def tentacle(numbers):
    ...
    try:
        ...
        return "Error: Invalid input format. Please use '[number,number,...]'."
...
if __name__ == "__main__":
    ...
    print(tentacle('[]'))  # Should print: 'Error: Invalid input format. Please use '[number,number,...]'.'
    print(tentacle('not a list'))  # Should print: 'Error: Invalid input format. Please use '[number,number,...]'.'