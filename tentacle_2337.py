...
def tentacle(statement):
    ...
    Returns:
    str: 'True' if the statement is logically valid or the result of a mathematical expression,
         'False' if the statement is not logically valid, or an error message if evaluation fails.
