...
def tentacle(expression):
    ...
    Returns:
    str or bool: The result of the evaluated expression as a string, or a boolean indicating if the logical statement is valid.
    ...
    try:
        ...
        # If evaluation fails, return False as it's not a valid mathematical expression or logical statement
        return False
