...
def tentacle(statement):
    ...
    This function checks if a given logical statement matches known logical equivalences.
    It also supports basic evaluation of mathematical expressions within the statement.
    
    Args:
    statement (str): A string containing a logical statement or mathematical expression.
    
    Returns:
    bool or str: True if the statement is logically valid, False if invalid, 
                 or a string result if the statement is a mathematical expression.
