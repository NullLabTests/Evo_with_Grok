...
def tentacle(statement):
    ...
    It first checks if the statement matches any predefined logical equivalences.
    If not, it attempts to evaluate the statement as a mathematical expression.
    ...
    try:
        ...
        # If evaluation fails, the statement is not a valid logical equivalence or mathematical expression
        return False
