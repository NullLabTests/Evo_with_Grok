...
def tentacle(statement):
    ...
    It first attempts to evaluate the statement as a mathematical expression, and if that
    fails, it checks the statement against a set of known logical equivalences.
    ...
    try:
        ...
        # If evaluation fails, proceed with logical statement validation
        pass
