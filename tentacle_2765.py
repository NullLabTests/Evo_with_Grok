...
if __name__ == "__main__":
    ...
    print(tentacle('A and B implies C'))  # Should print: True if A, B, and C are defined as True
    print(tentacle('not A or B'))  # Should print: True if A is False or B is True