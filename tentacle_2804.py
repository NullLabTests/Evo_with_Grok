...
def tentacle(statement):
    ...
    This function evaluates a logical statement and returns True if the statement
    is logically valid, and False otherwise. It uses a set of predefined logical
