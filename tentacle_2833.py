...
def tentacle(statement):
    ...
    This function evaluates logical statements by checking them against a list of known logical equivalences.
    ...
    Returns:
    bool or str: True if the statement is logically valid, False if it's not valid, or a string result for mathematical expressions.
