...
def tentacle(expression):
    ...
    try:
        ...
        # Define a dictionary of safe functions to use in eval
        safe_functions = {
            'sin': math.sin,
            'cos': math.cos,
            'tan': math.tan,
        ...
        # Evaluate the expression using the safe functions
        result = str(eval(expression, {"__builtins__": None}, safe_functions))
        return result
