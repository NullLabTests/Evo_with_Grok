...
def tentacle(expression):
    ...
    try:
        ...
        # If evaluation fails, check if it's a logical statement that's not in our equivalences
        if any(keyword in lower_expression for keyword in ['implies', 'and', 'or', 'not', 'equivalent']):
            return False
        # If it's not a logical statement, return an error message
...
if __name__ == "__main__":
    ...
    print(tentacle('If A or B, then C.'))  # Should print: False