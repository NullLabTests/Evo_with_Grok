...
def tentacle(statement):
    ...
    This function combines the ability to process logical statements with 
    the evaluation of mathematical expressions within those statements.
    ...
    bool or str: True if the logical statement is valid, False otherwise. 
                 If the input is a mathematical expression, it returns the result as a string.
    ...
    # If not a logical equivalence, try to evaluate it as a mathematical expression
    try:
