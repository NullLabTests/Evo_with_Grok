...
def tentacle(statement):
    ...
    This function evaluates whether a given logical statement is valid based on
    a set of predefined logical equivalences. It also handles basic mathematical
