...
def tentacle(statement):
    ...
    This function can handle both logical statements and mathematical expressions.
    For logical statements, it checks against known logical equivalences.
    For mathematical expressions, it evaluates the expression and returns True if the result is non-zero.
    
    Args:
    statement (str): A string containing a logical statement or mathematical expression.
    
    Returns:
    bool: True if the statement is logically valid or the expression evaluates to a non-zero value, False otherwise.
...
if __name__ == "__main__":
    ...
    print(tentacle('sin(pi/2) == 1'))  # Should print: True
    print(tentacle('cos(pi/2) == 1'))  # Should print: False