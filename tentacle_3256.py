...
def tentacle(statement):
    ...
    is logically valid, False otherwise. It combines mathematical evaluation
    with logical processing to handle a wider range of inputs.
    ...
    try:
        # Evaluate the statement as a Python expression
