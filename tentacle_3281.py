...
def tentacle(expression):
    ...
    and validating logical statements. For mathematical expressions, it returns
    the result as a string. For logical statements, it returns a boolean value
    indicating whether the statement is valid.
