...
def tentacle(statement):
    ...
    This function evaluates the logical validity of a given statement by checking
    it against a set of predefined logical equivalences. It also handles basic
    mathematical expressions within the statement.

    Args:
    statement (str): A string containing a logical statement or mathematical expression.

    Returns:
    bool: True if the statement is logically valid or the mathematical expression is correct, False otherwise.
    ...
    try:
        # Split the statement into left and right sides if it contains '=='
        if '==' in statement:
            ...
            # If no '==', just evaluate the expression
...
if __name__ == "__main__":
    ...
    print(tentacle('2 + 2'))  # Should print: True (evaluates to 4, which is True in boolean context)
    print(tentacle('2 - 2'))  # Should print: False (evaluates to 0, which is False in boolean context)