...
def tentacle(statement):
    ...
    expressions within the logical statements.
...
if __name__ == "__main__":
    ...
    print(tentacle('5 / 2 == 2.5'))  # Should print: True
    print(tentacle('x = 5'))  # Should print: False (assignment, not a valid expression)