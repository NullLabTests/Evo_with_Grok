...
def tentacle(numbers):
    ...
    Returns:
    str: The maximum value from the list as a string.
...
if __name__ == "__main__":
    ...
    print(tentacle('[1, 2, "three"]'))  # Should print: Error: List must contain only numbers.
    print(tentacle('not a list'))  # Should print: Error: <some error message>