...
def tentacle(statement):
    ...
    is logically valid, False otherwise. It supports a set of predefined logical
    equivalences and can evaluate simple mathematical expressions within statements.
