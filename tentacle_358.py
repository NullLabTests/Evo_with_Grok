...
def tentacle(statement):
    ...
    try:
        ...
        expression = expression.replace("if", "").replace("then", "")
...
if __name__ == "__main__":
    ...
    print(tentacle('A or B'))  # Should print: True
    print(tentacle('not (A and B)'))  # Should print: True
    print(tentacle('not (A or B)'))  # Should print: True
    print(tentacle('A implies B'))  # Should print: True
    print(tentacle('A is equivalent to B'))  # Should print: True
