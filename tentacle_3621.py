...
if __name__ == "__main__":
    ...
    print(tentacle('Check out www.example.com and https://subdomain.example.com/path?query=string'))  # Should print: ['www.example.com', 'https://subdomain.example.com/path?query=string']
