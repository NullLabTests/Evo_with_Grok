...
def tentacle(expression):
    ...
    if lowercase_expression in equivalences:
        ...
        try:
            ...
            try:
                # Evaluate the expression as a Python expression
                result = str(eval(lowercase_expression))
                return result
            except Exception as e:
                # If all evaluations fail, return an error message
                return f"Error: Invalid expression or logical statement"
...
if __name__ == "__main__":
    ...
    print(tentacle('invalid expression'))  # Should print: Error: Invalid expression or logical statement