...
def tentacle(expression):
    ...
    Returns:
    str or bool: The result of the evaluated mathematical expression as a string, or a boolean value indicating
                 whether the logical statement is true or false.
    ...
    if expression in equivalences:
        return True
    elif any(equivalence in expression for equivalence in equivalences):
        return True
    else:
        ...
        try:
            ...
            # If evaluation fails, check if it's a logical statement not in the equivalences list
            if any(keyword in expression for keyword in ['implies', 'and', 'or', 'not', 'equivalent']):
                return False
            else:
