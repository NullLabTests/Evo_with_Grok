    ...
    if lower_expression in equivalences:
        ...
        try:
            ...
            try:
                ...
                logical_result = str(eval(lower_expression))
                return logical_result
            except Exception:
                # If both evaluations fail, return an error message
                return f"Error: Unable to evaluate '{expression}'"
...
if __name__ == "__main__":
    ...
    print(tentacle('Invalid expression'))  # Should print: Error: Unable to evaluate 'Invalid expression'