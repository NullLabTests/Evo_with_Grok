...
def tentacle(statement):
    ...
    True
    """
    # Convert the statement to lowercase for consistent processing
...
if __name__ == "__main__":
    ...
    print(tentacle('A and B implies C'))  # Should print: False (assuming A=False, B=False, C=True)
    print(tentacle('A or B or C'))  # Should print: True (assuming A=False, B=False, C=True)