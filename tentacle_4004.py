...
if __name__ == "__main__":
    ...
    print(tentacle('A and B implies C'))  # Should print: False (example of a statement not in equivalences)
    print(tentacle('A and (B or C)'))  # Should print: False (example of a statement not in equivalences)