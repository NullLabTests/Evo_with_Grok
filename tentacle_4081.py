...
def tentacle(statement):
    ...
    It also supports basic mathematical expression evaluation within logical statements.
    
    Args:
    statement (str): A string containing a logical statement, possibly including mathematical expressions.
    ...
    def evaluate_expression(expr):
        try:
            ...
            return expr  # Return the expression as-is if evaluation fails
    
    # Replace mathematical expressions with their evaluated results
    import re
    statement = re.sub(r'\b\d+[\+\-\*\/]\d+\b', lambda m: evaluate_expression(m.group()), statement)
