...
def tentacle(text):
    ...
    Args:
    text (str): A string containing text from which URLs are to be extracted.
    ...
    url_pattern = r'https?://(?:www\.)?[-\w@:%.+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b(?:[-\w()@:%+.~#?&/=]*)'
...
if __name__ == "__main__":
    ...
    print(tentacle('Multiple URLs: http://example.com and https://www.test.org'))  # Should print: http://example.com