...
def tentacle(statement):
    ...
    It also includes the ability to evaluate simple mathematical expressions within logical statements.
...
if __name__ == "__main__":
    ...
    print(tentacle('x = 5'))  # Should print: False (assignment is not a boolean expression)
