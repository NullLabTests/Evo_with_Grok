...
def tentacle(statement):
    ...
    equivalences and returns True if the statement matches any of them, False otherwise.
    ...
    try:
        ...
        # If the result is a number, assume the statement is a comparison and check if it's true
        return bool(result)
    except:
