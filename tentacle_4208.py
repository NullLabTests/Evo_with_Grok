...
def tentacle(text):
    ...
    persons = [p for p in persons if p[0].isupper() and p.lower() not in ['the', 'a', 'an', 'to', 'in', 'at']]
...
if __name__ == "__main__":
    ...
    print(tentacle('The cat is sleeping on the couch.'))  # Should print: (nothing, as no persons or locations are detected)