...
def tentacle(statement):
    ...
    This function evaluates logical statements by checking them against
    a set of known logical equivalences. It also uses Python's eval function
    to handle simple mathematical expressions within the statement.

    Args:
    statement (str): A string containing a logical statement or mathematical expression.

    Returns:
    bool or str: True if the logical statement is valid, False if not valid,
                 or a string result for mathematical expressions.
