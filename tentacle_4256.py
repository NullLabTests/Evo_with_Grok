...
def tentacle(expression):
    """
    Evaluate a mathematical expression given as a string and validate logical statements.
    ...
    if expression.startswith('if') and expression.endswith('.'):
        return expression in logical_equivalences
    
    # If not a logical statement, treat it as a mathematical expression
    try:
