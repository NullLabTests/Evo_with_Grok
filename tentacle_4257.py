...
def tentacle(statement):
    ...
    This function evaluates logical statements by checking them against a list of known
    logical equivalences. It also supports basic mathematical expressions within the statements.
