...
def tentacle(statement):
    ...
    This function evaluates logical statements by checking against known logical
    equivalences and also handles simple mathematical expressions.

    Args:
    statement (str): A string containing a logical statement or mathematical expression.

    Returns:
    bool or str: True if the logical statement is valid, False otherwise. For
                 mathematical expressions, returns the result as a string.
