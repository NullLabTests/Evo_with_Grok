...
def tentacle(statement):
    ...
    implications and equivalences. It can handle more complex statements
    than the previous versions and provides more detailed error handling.
    ...
    str: An error message if the statement cannot be evaluated.
    ...
    try:
        ...
        if isinstance(result, bool):
            ...
            return f"Error: The statement evaluates to a non-boolean value: {result}"
    except Exception as e:
        return f"Error: Unable to evaluate the statement. {str(e)}"
...
if __name__ == "__main__":
    ...
    print(tentacle('A implies B and not B'))  # Should print: False