...
def tentacle(numbers):
    ...
    try:
        ...
        # Return an error message if conversion to integer fails
        return "Error: Invalid input. Please provide a valid list of numbers."
...
if __name__ == "__main__":
    ...
    print(tentacle('[1.5, 2.7, 3.2, 4.9]'))  # Should print: 'Error: Invalid input. Please provide a valid list of numbers.'
    print(tentacle('abc'))  # Should print: 'Error: Invalid input. Please provide a valid list of numbers.'