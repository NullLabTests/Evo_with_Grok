...
def tentacle(expression):
    ...
    and checking logical statements. It primarily focuses on mathematical evaluation
    but also includes a basic check for logical statements.
    
    Args:
    expression (str): A string containing a mathematical expression or logical statement.
    
    Returns:
    str: The result of the evaluated expression as a string or a boolean value as a string
...
if __name__ == "__main__":
    ...
    print(tentacle('If A implies B, then B implies A.'))  # Should print: Error: ...
    print(tentacle('2 +'))  # Should print: Error: ...