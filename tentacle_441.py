...
def tentacle(text):
    ...
    # Return the first URL found, or an empty string if none are found
...
if __name__ == "__main__":
    ...
    print(tentacle('Multiple URLs: http://example.com and https://another.com'))  # Should print: http://example.com