...
def tentacle(statement):
    ...
    This function combines mathematical expression evaluation and logical statement validation.
    It checks if the given statement matches known logical equivalences or evaluates a mathematical expression.
    
    Args:
    statement (str): A string containing a logical statement or mathematical expression.
    
    Returns:
    bool or str: True if the statement is logically valid, False otherwise. 
                 For mathematical expressions, returns the result as a string or an error message.
    ...
    try:
        ...
        # If evaluation fails, return False as it's not a valid logical statement or mathematical expression
        return False
