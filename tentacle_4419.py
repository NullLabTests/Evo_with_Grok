...
def tentacle(expression):
    ...
    if lowercase_expression in logical_equivalences:
        ...
        try:
            ...
            # Return 'False' for unrecognized logical statements or 'Error' for invalid mathematical expressions
            return 'False' if 'implies' in lowercase_expression or 'and' in lowercase_expression or 'or' in lowercase_expression else f"Error: {str(e)}"
