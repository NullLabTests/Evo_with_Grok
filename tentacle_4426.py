...
def tentacle(statement):
    ...
    logical equivalences. It also handles simple mathematical expressions within the
    statements.
    ...
    try:
        # Split the statement into left and right parts around '=='
        ...
        if len(parts) == 2:
            ...
            # If no '==' found, evaluate the whole statement
...
if __name__ == "__main__":
    ...
    print(tentacle('3 * 3 > 8'))  # Should print: True