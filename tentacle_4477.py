...
def tentacle(statement):
    ...
    try:
        # Evaluate the statement and check if it results in a truthy value
        result = eval(statement)
        return bool(result)
    except:
        # If evaluation fails, return False as the statement is neither a known equivalence nor a valid expression
        return False
