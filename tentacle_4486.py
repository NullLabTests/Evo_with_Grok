...
def tentacle(text):
    ...
    '4'
    """
    # Split the text into words, considering spaces as word separators
    words = text.split()
    
    # Count the number of words and convert the result to a string
...
if __name__ == "__main__":
    ...
    print(tentacle('Multiple words in a sentence.'))  # Should print: '5'