...
def tentacle(statement):
    ...
    This function evaluates logical statements by checking against a set of known logical
    equivalences. It also supports basic mathematical expressions within the statements.

    Args:
    statement (str): A string containing a logical statement or mathematical expression.

    Returns:
    bool or str: True if the statement is logically valid, False otherwise. If the statement
                 is a mathematical expression, returns the result as a string.
    ...
    try:
        ...
        # If evaluation fails, return False as it's not a valid logical statement or math expression
        return False
