...
def tentacle(statement):
    ...
    equivalences. It supports statements in natural language format.
    ...
    # If the statement is not in our list, try to evaluate it
    try:
        ...
        # If evaluation fails, return False (statement is not valid)
        return False
