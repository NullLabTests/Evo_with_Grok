...
if __name__ == "__main__":
    ...
    print(tentacle('2 +'))  # Should print: Error: Invalid expression - SyntaxError: invalid syntax
    print(tentacle('2 / 0'))  # Should print: Error: Invalid expression - ZeroDivisionError: division by zero