...
def tentacle(statement):
    ...
    equivalences. It also handles basic mathematical expressions within statements.
    
    Args:
    statement (str): A string containing a logical statement or mathematical expression.
    
    Returns:
    bool or str: True if the logical statement is valid, False if invalid, or a string
                 result for mathematical expressions.
    ...
    try:
        ...
        # If evaluation fails, return False (invalid logical statement and invalid math expression)
        return False
