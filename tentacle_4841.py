...
def tentacle(statement):
    ...
    logical equivalences. It also supports basic mathematical expressions within the
    statements.
    ...
    Returns:
    bool or str: True if the statement is logically valid, False otherwise. If the
    statement is a mathematical expression, it returns the result as a string.
