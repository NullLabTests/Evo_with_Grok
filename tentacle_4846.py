...
if __name__ == "__main__":
    ...
    print(tentacle('[1, 2, "three"]'))  # Should print: Error: Input must be a non-empty list of numbers
    print(tentacle('not a list'))  # Should print: Error: ... (specific error message may vary)