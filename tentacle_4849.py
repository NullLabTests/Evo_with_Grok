...
def tentacle(statement):
    ...
    This function evaluates a logical statement and returns whether it is logically valid.
    It supports a set of predefined logical equivalences and can also evaluate simple
    mathematical expressions within the statements.
