...
if __name__ == "__main__":
    ...
    print(tentacle('A and B'))  # Should print: False (because A and B are undefined)
    print(tentacle('not A or B'))  # Should print: False (because A and B are undefined)
    print(tentacle('A implies B'))  # Should print: False (because A and B are undefined)