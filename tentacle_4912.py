...
def tentacle(expression):
    ...
    try:
        ...
        # Evaluate the expression using eval with math module access
        result = eval(expression, {"__builtins__": None}, {"math": math})
        
        # Convert the result to a string and format it to 10 decimal places
        return f"{result:.10g}"
...
if __name__ == "__main__":
    ...
    print(tentacle('log(100)'))  # Should print: 2
