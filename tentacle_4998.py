...
def tentacle(numbers):
    ...
    try:
        ...
        number_list = [int(num.strip()) for num in numbers.strip('[]').split(',')]
...
if __name__ == "__main__":
    ...
    print(tentacle('[]'))  # Should print: Error: Invalid input. Please provide a list of numbers.
    print(tentacle('[a,b,c]'))  # Should print: Error: Invalid input. Please provide a list of numbers.