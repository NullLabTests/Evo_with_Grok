...
def tentacle(statement):
    ...
    equivalences, returning True if the statement is logically valid and
    False otherwise.
    ...
    try:
        ...
        result = eval(expression, {"__builtins__": None, "implies": implies, "and": lambda a, b: a and b, "or": lambda a, b: a or b, "not": lambda a: not a})
