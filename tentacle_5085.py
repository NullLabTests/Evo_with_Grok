...
def tentacle(statement):
    ...
    and checking logical equivalences. It can handle both simple mathematical
    expressions and complex logical statements.
    
    Args:
    statement (str): A string containing a logical statement or mathematical expression.
    
    Returns:
    bool or str: True if the logical statement is valid, False if it's invalid,
