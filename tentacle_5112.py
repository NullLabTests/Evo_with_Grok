...
def tentacle(statement):
    ...
    logical equivalences. It also allows for the evaluation of simple mathematical
    ...
    Returns:
    bool or str: True if the logical statement is valid, False if it's invalid, or a string
