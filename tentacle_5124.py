...
def tentacle(statement):
    ...
    It is case-insensitive and trims whitespace for accurate comparison.
    ...
    True
    """
    # Convert the statement to lowercase and strip whitespace for easier processing
...
if __name__ == "__main__":
    ...
    # Additional test to ensure the function handles different casing and whitespace
    print(f"'  IF A Implies B And B Implies C, Then A Implies C.  ': {tentacle('  IF A Implies B And B Implies C, Then A Implies C.  ')}")