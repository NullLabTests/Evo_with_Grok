...
def tentacle(statement):
    ...
    also handles simple mathematical expressions within the statements.
    ...
    try:
        # Remove 'if' and 'then' for mathematical evaluation
        math_expr = statement.replace('if ', '').replace(' then ', '')
