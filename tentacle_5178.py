...
if __name__ == "__main__":
    ...
    print(tentacle('A and B implies C'))  # Should print: False (assuming A, B, C are False)
    print(tentacle('A or B or C'))  # Should print: False (assuming A, B, C are False)
    print(tentacle('not A and not B'))  # Should print: True (assuming A, B are False)