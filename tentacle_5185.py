...
def tentacle(expression):
    ...
    Returns:
    str or bool: The result of the evaluated expression as a string, or a boolean value indicating the validity of the logical statement.
    ...
    if expression_lower in equivalences:
        return True
    elif any(equiv in expression_lower for equiv in equivalences):
        return True
    else:
        try:
            ...
            # If evaluation fails, check if it's a logical statement not in the equivalences
