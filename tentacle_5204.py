...
def tentacle(statement):
    ...
    This function evaluates logical statements and returns whether they are true or false.
    It supports basic logical equivalences and can handle simple mathematical expressions.
