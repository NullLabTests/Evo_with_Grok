...
def tentacle(statement):
    ...
    This function evaluates logical statements based on predefined logical equivalences.
    It can also handle simple mathematical expressions within logical statements.
    
    Args:
    statement (str): A string containing a logical statement or a mathematical expression.
    
    Returns:
    bool or str: True if the logical statement is valid, False if invalid, or a string result for mathematical expressions.
