...
def tentacle(expression):
    """
    Evaluate a mathematical expression given as a string and return the result.
    
    This function combines the capabilities of evaluating mathematical expressions
    and logical statements. For mathematical expressions, it returns the result
    as a string. For logical statements, it returns 'True' or 'False' based on
    ...
    if lowercase_expression in logical_equivalences:
        ...
        try:
            ...
            # and an error message for invalid mathematical expressions
            return 'False' if 'implies' in lowercase_expression or 'equivalent' in lowercase_expression else f"Error: {str(e)}"
