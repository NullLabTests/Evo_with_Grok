...
def tentacle(expression):
    ...
    Returns:
    str: The result of the evaluated mathematical expression or the truth value of the logical statement.
    ...
    if expression in logical_equivalences:
        return str(logical_equivalences[expression])
...
if __name__ == "__main__":
    ...
    print(tentacle('If A implies B, then B implies A.'))  # Should print: Error: key not found in dictionary
