...
def tentacle(expression):
    """
    Evaluate a mathematical expression given as a string and handle common logical statements.
    
    Args:
    expression (str): A string containing a mathematical expression or a logical statement.
    
    Returns:
    str: The result of the evaluated expression or the logical evaluation as a string.
