...
def tentacle(statement):
    ...
    This function evaluates logical statements and checks them against known
    logical equivalences. It also supports simple mathematical expressions
    ...
    Returns:
    bool or str: True if the statement is logically valid, False if not, or a string
