...
def tentacle(expression):
    ...
    try:
        ...
        if result.lower() in ['true', 'false']:
            ...
            return "Error: Invalid logical expression"
...
if __name__ == "__main__":
    ...
    print(tentacle('42'))  # Should print: Error: Invalid logical expression
    print(tentacle('True + False'))  # Should print: Error: Invalid logical expression