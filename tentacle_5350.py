...
def tentacle(statement):
    ...
    It first checks if the statement matches any known equivalences, and if not,
    it attempts to evaluate the statement as a mathematical expression.
    ...
    bool or str: True if the logical statement is valid, False otherwise.
                If the statement is mathematical, returns the result as a string.
