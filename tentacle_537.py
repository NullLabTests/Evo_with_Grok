...
def tentacle(statement):
    ...
    This function evaluates logical statements by comparing them against a set of known logical equivalences.
    It also supports basic mathematical expression evaluation for statements that include numerical operations.

    Args:
    statement (str): A string containing a logical statement or a mathematical expression.

    Returns:
    bool or str: True if the statement is logically valid, False otherwise. For mathematical expressions,
    ...
    try:
        ...
        # If evaluation fails, it's neither a known logical equivalence nor a valid mathematical expression
        return False
...
if __name__ == "__main__":
    ...
    print(tentacle('10 / 0'))  # Should print: False