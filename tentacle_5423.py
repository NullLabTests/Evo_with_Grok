...
def tentacle(statement):
    ...
    This function evaluates the given logical statement against a set of known logical equivalences.
    It converts the input to lowercase and checks for exact matches with predefined statements.
    
    Args:
    statement (str): A string containing a logical statement.
    
    Returns:
    bool: True if the statement is logically valid according to predefined equivalences, False otherwise.
