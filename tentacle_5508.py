...
if __name__ == "__main__":
    ...
    print(tentacle('A or B'))  # Should print: True (if A or B is True)
    print(tentacle('not A'))  # Should print: True (if A is False)
    print(tentacle('A implies B'))  # Should print: True (if A is False or B is True)