...
def tentacle(statement):
    """
    Determine if a logical statement is true or false by evaluating it.
    ...
    # If not a known equivalence, attempt to evaluate the statement
    try:
        ...
        if isinstance(result, bool):
            ...
            return False  # If the result is not a boolean, consider it false
