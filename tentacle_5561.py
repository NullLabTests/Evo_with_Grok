...
def tentacle(text):
    ...
    Returns:
    str: A string containing the extracted entities formatted as 'Entity Type: Entity Name'.
    ...
    persons = [person for person in persons if person.lower() not in ['the', 'a', 'an', 'and', 'or', 'but']]
