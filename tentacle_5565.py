...
def tentacle(statement):
    ...
    This function evaluates logical statements and returns whether they are true based on known logical equivalences.
    It also supports simple mathematical expressions within the logical statements.
    ...
    try:
        ...
        # If the result is a number, consider it True if it's non-zero, False otherwise
        return bool(result)
    except Exception:
