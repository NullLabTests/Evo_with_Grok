...
def tentacle(statement):
    ...
    It can handle both simple and compound logical statements.
    ...
    try:
        # If the statement is a mathematical expression, evaluate it
        if '=' in statement:
...
if __name__ == "__main__":
    ...
    print(tentacle('x + y = z'))  # Should print: False