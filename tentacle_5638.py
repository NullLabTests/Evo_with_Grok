...
def tentacle(statement):
    ...
    implications and equivalences. It can handle statements with variables
    A, B, and C, and determine their logical validity.
    ...
    try:
        ...
        if isinstance(result, bool):
            ...
            # If the result is not a boolean, the statement is invalid
            return False
    except Exception as e:
        # If evaluation fails, the statement is considered invalid
        return False
...
if __name__ == "__main__":
    ...
    print(tentacle('A or B and C'))  # Should print: False
