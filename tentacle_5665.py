...
if __name__ == "__main__":
    ...
    print(tentacle('A implies B and B implies C'))  # Should print: True (assuming A, B, C are True)
    print(tentacle('not A or B'))  # Should print: True (assuming A is False and B is True)
    print(tentacle('A and B and C'))  # Should print: True (assuming A, B, C are True)
    print(tentacle('A or B or C'))  # Should print: True (assuming at least one of A, B, C is True)