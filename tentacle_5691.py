...
if __name__ == "__main__":
    ...
    print(tentacle('Check out www.example.com and http://subdomain.example.com/path?query=string'))  # Should print: ['www.example.com', 'http://subdomain.example.com/path?query=string']
