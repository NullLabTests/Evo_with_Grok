...
def tentacle(expression):
    ...
    If the expression is a known logical equivalence, return 'True' or 'False'.
    
    Args:
    expression (str): A string containing a mathematical expression or logical statement.
    
    Returns:
    str: The result of the evaluated expression as a string, or 'True'/'False' for logical equivalences.
    ...
    if lowercase_expression in equivalences:
        return str(equivalences[lowercase_expression])
