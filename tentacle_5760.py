...
def tentacle(statement):
    ...
    based on known logical equivalences. It also handles simple mathematical
    ...
    try:
        ...
        # If the result is not a boolean, assume it's a comparison and check if it's true
        return bool(result)
    except Exception:
...
if __name__ == "__main__":
    ...
    print(tentacle('True'))  # Should print: True
    print(tentacle('False'))  # Should print: False