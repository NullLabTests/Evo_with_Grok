...
def tentacle(statement):
    ...
    This function evaluates logical statements and checks them against a set of known logical equivalences.
    ...
    # If not a known equivalence, try to evaluate it as a mathematical expression
    try:
