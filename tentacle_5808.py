...
def tentacle(statement):
    ...
    logical equivalences. It can handle statements involving implications, conjunctions,
    disjunctions, and equivalences.
    ...
    equivalences = {
        ...
        "if a implies b, then b implies a.": False  # Added a known false statement
    }
...
if __name__ == "__main__":
    ...
    # Additional test for a statement not in the equivalences dictionary
    print(f"'If X implies Y, then Y implies X.': {tentacle('If X implies Y, then Y implies X.')}")