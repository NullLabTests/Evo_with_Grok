...
def tentacle(expression):
    ...
    if expression in logical_equivalences:
        return True
    ...
    try:
        ...
        # Return False for unrecognized logical statements or an error message for invalid mathematical expressions
        return False if any(keyword in expression for keyword in ['implies', 'and', 'or', 'not', 'equivalent']) else f"Error: {str(e)}"
