...
if __name__ == "__main__":
    ...
    print(tentacle('7,2,9,4,6,1,3,8,5'))  # Should print: '1,2,3,4,5,6,7,8,9'
    print(tentacle('invalid input'))  # Should print: 'Error: Invalid input. Please provide a list of numbers separated by commas.'