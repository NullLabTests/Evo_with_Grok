...
def tentacle(expression):
    """
    Evaluate a mathematical expression given as a string and verify if it's a known logical equivalence.
    ...
    str or bool: If the input is a mathematical expression, returns the result as a string.
                 If the input is a logical statement, returns True if it's a known logical equivalence, False otherwise.
    ...
    try:
        ...
        # If evaluation fails and it's not a known logical equivalence, return False
        return False
