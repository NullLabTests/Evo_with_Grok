...
def tentacle(statement):
    ...
    try:
        ...
        if '==' in statement:
            ...
            # If no comparison operator, evaluate as a simple expression
...
if __name__ == "__main__":
    ...
    print(tentacle('3 * 4 > 10'))  # Should print: True
    print(tentacle('5 - 2 != 3'))  # Should print: False
    print(tentacle('10 / 2 <= 5'))  # Should print: True
    print(tentacle('7 % 3 == 1'))  # Should print: True
    print(tentacle('2 ** 3'))  # Should print: True (evaluates to 8, which is truthy)