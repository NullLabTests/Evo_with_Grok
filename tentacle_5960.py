...
def tentacle(statement):
    ...
    equivalences and returns True if the statement matches any of these equivalences.
    
    Args:
    statement (str): A string containing a logical statement.
    
    Returns:
    bool: True if the statement is logically valid according to predefined equivalences,
          False otherwise.
