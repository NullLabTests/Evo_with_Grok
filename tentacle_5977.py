...
def tentacle(statement):
    ...
    This function evaluates logical statements and checks if they are valid
    based on a set of predefined logical equivalences. It also handles
    simple mathematical expressions within the statements.
