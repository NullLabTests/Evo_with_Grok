...
def tentacle(statement):
    ...
    Returns:
    str: 'True' if the logical statement is valid, the result of the mathematical expression, or an error message.
...
if __name__ == "__main__":
    ...
    print(tentacle('If A implies B, then B implies A.'))  # Should print: Error: statement.strip() not in equivalences
