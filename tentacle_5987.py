...
def tentacle(statement):
    ...
    logical equivalences. It also handles simple mathematical expressions
    ...
    Returns:
    bool: True if the statement is logically valid or the mathematical expression is true,
          False otherwise.
    ...
    # If not a known equivalence, check if it's a mathematical expression
    try:
        ...
        # If the result is a number, consider it true if non-zero
        return result != 0
    except:
        # If evaluation fails, assume it's not a valid logical or mathematical statement
        return False
