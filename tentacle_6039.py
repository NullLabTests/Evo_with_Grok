...
def tentacle(statement):
    ...
    Args:
    statement (str): A string containing a logical statement with possible embedded mathematical expressions.
    ...
    True
    >>> tentacle('If 2 + 2 == 4, then A implies B.')
    True
    """
    ...
    # Evaluate any mathematical expressions in the statement
    import re
    math_expressions = re.findall(r'\b\d+(?:[\+\-\*/]\d+)+\b', statement)
...
if __name__ == "__main__":
    ...
    print(tentacle('If 2 + 2 == 4, then A implies B.'))  # Should print: True
    print(tentacle('If 2 + 2 == 5, then A implies B.'))  # Should print: False