...
def tentacle(expression):
    """
    Evaluate a mathematical expression given as a string and optionally verify logical statements.
    
    Args:
    expression (str): A string containing a mathematical expression or a logical statement.
    
    Returns:
    str or bool: The result of the evaluated expression as a string, or a boolean indicating the validity of a logical statement.
