...
if __name__ == "__main__":
    ...
    print(tentacle('(True and True) or (False and True)'))  # Should print: True
    print(tentacle('not not True'))  # Should print: True
    print(tentacle('True == False'))  # Should print: False
    print(tentacle('not (True == False)'))  # Should print: True
