...
if __name__ == "__main__":
    ...
    print(tentacle('1 == 1'))  # Should print: True
    print(tentacle('2 > 3'))  # Should print: False
    print(tentacle('invalid expression'))  # Should print: Error: invalid syntax (<string>, line 1)
    print(tentacle('2 + 2'))  # Should print: Error: Result is not a boolean value