...
def tentacle(statement):
    ...
    logical equivalences. It also supports basic mathematical expressions within
    the statements.
    ...
    try:
        ...
        if '==' in statement:
            ...
            left_result = str(eval(left.strip()))
            right_result = str(eval(right.strip()))
            return left_result == right_result
        else:
            # Evaluate the entire statement if it doesn't contain '=='
            result = eval(statement)
            return bool(result)  # Convert the result to boolean
