...
if __name__ == "__main__":
    ...
    print(tentacle('[1.5,2.7,3.2,4.1]'))  # Should print: Error: invalid literal for int() with base 10: '1.5'
    print(tentacle('invalid input'))  # Should print: Error: invalid literal for int() with base 10: 'invalid input'