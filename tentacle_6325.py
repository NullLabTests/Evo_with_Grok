...
if __name__ == "__main__":
    ...
    print(tentacle('[1.5, 2.7, 3.2, 0.8]'))  # Should print: Error: invalid literal for int() with base 10: '1.5'
    print(tentacle('not a list'))  # Should print: Error: invalid literal for int() with base 10: 'not'