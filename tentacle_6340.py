...
if __name__ == "__main__":
    ...
    print(tentacle('2*x + 3 = 2*x + 3'))  # Should print: Error: Division by zero (coefficient of x cannot be zero)
    print(tentacle('2*x + 3 = y'))  # Should print: Error: Invalid number format in the equation
