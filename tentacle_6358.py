...
def tentacle(statement):
    ...
    as a mathematical expression, and if that fails, it checks the statement
    against a list of known logical equivalences.
    ...
    try:
        ...
        # If evaluation fails, treat it as a logical statement
        pass
