...
def tentacle(expression):
    ...
    Returns:
    str or bool: The result of the evaluated mathematical expression as a string, or 
                 True/False for the validity of a logical statement.
    ...
    if lower_expression in equivalences:
        ...
        try:
            ...
            # If evaluation fails, it might be a logical statement not in the equivalences list
            return False
