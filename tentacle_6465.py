...
def tentacle(statement):
    ...
    try:
        ...
        def evaluate(expr):
            if "->" in expr:
                a, b = expr.split("->")
                return not evaluate(a.strip()) or evaluate(b.strip())
            return eval(expr)
...
if __name__ == "__main__":
    ...
    print(tentacle('If A implies B and not B, then not A.'))  # Should print: True
    print(tentacle('If A or B and not A, then B.'))  # Should print: True