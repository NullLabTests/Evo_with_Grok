...
def tentacle(statement):
    ...
    equivalences = {
        ...
        "if a implies b, then b implies a.": False  # This is not a valid equivalence
    }
    ...
    # If the statement is not in the equivalences, try to evaluate it
    try:
...
if __name__ == "__main__":
    ...
    print(tentacle('A and B implies C'))  # Should print: False (example of a new statement)
    print(tentacle('not A or B'))  # Should print: True (example of a new statement)