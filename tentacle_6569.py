...
if __name__ == "__main__":
    ...
    print(tentacle('A and (B or C) == (A and B) or (A and C)'))  # Should print: True
    print(tentacle('not (A and B) == not A or not B'))  # Should print: True
    print(tentacle('A implies B == not A or B'))  # Should print: True