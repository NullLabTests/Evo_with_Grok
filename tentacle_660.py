...
def tentacle(statement):
    ...
    # If not found in equivalences, attempt to evaluate the expression
    try:
        ...
        # If the result is truthy, consider the statement valid
        return bool(result)
    except Exception:
        # If evaluation fails, consider the statement invalid
        return False
