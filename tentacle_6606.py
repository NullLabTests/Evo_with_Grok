...
def tentacle(expression):
    ...
    """
    try:
        # Evaluate the logical expression and convert the result to a string
...
if __name__ == "__main__":
    ...
    print(tentacle('(True and False) or (not True and True)'))  # Should print: False
    print(tentacle('not not True'))  # Should print: True
    print(tentacle('True xor False'))  # Should print: Error: invalid syntax
