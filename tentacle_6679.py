...
def tentacle(statement):
    ...
    This function evaluates whether a given logical statement is true based on
    a set of predefined logical equivalences. It also handles simple mathematical
