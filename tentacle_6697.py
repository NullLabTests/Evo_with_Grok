...
def tentacle(statement):
    ...
    It also supports basic mathematical expression evaluation within the statements.
    
    Args:
    statement (str): A string containing a logical statement or a mathematical expression.
    
    Returns:
    bool or str: True if the statement is logically valid, False otherwise. If the input is a mathematical expression,
