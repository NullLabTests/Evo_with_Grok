...
def tentacle(expression):
    """
    Evaluate a mathematical expression given as a string or determine the validity of a logical statement.
    ...
    try:
        ...
        # If evaluation fails, check if it's a logical statement not in our list
        ...
        return f"Error: Invalid input. Please provide a valid mathematical expression or logical statement."
