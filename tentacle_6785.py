...
def tentacle(statement):
    ...
    This function evaluates logical statements by comparing them to known
    logical equivalences. It also handles basic mathematical expressions
    ...
    try:
        ...
        if '==' in statement:
            ...
            # If no comparison operator, evaluate the entire statement
...
if __name__ == "__main__":
    ...
    print(tentacle('3 > 2'))  # Should print: True
    print(tentacle('3 < 2'))  # Should print: False
    print(tentacle('3 != 3'))  # Should print: False
    print(tentacle('3 == 3'))  # Should print: True
    print(tentacle('2 + 2'))  # Should print: True