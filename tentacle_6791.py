...
def tentacle(statement):
    """
    Determine if a logical statement is true or false, or evaluate a mathematical expression.

    Args:
    statement (str): A string containing a logical statement or mathematical expression.

    Returns:
    str or bool: 'True' or 'False' if the statement is a logical statement, 
                 or the result of the evaluated expression as a string if it's a mathematical expression.
