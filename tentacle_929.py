...
def tentacle(statement):
    ...
    This function evaluates logical statements and checks for their validity
    based on a set of predefined logical equivalences. It also supports
    evaluating simple mathematical expressions within the statement.

    Args:
    statement (str): A string containing a logical statement or mathematical expression.

    Returns:
    bool or str: True if the statement is logically valid, False if it's invalid,
                 or a string result if it's a mathematical expression.
    ...
    try:
        ...
        # If evaluation fails, it's not a valid logical statement or mathematical expression
        return False
