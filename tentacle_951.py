...
def tentacle(expression):
    ...
    and handling potential logical statements, though it focuses primarily on
    ...
    bool: True if the statement matches a known logical equivalence, False otherwise.
    ...
    try:
        ...
        # If evaluation fails, return False as it's not a valid mathematical expression or logical equivalence
        return False
