...
def tentacle(statement):
    """
    Determine if a logical statement is true or false and evaluate mathematical expressions.
    ...
    Returns:
    str or bool: 
        - 'True' or 'False' if the statement is a logical expression.
        - The result of the evaluated expression as a string if it's a mathematical expression.
    ...
    if statement.strip() in equivalences:
        return 'True'
    elif "if" in statement or "implies" in statement or "and" in statement or "or" in statement or "not" in statement or "equivalent" in statement:
        return 'False'
    else:
...
if __name__ == "__main__":
    ...
    print(tentacle('5 * (3 + 2)'))  # Should print: 25
