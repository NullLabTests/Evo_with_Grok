...
def tentacle(expression):
    ...
    if expression_lower in equivalences:
        ...
        try:
            # Evaluate the expression as a mathematical expression and convert the result to a string
            result = str(eval(expression))
            return result
        except Exception as e:
            # Return 'False' if it's not a valid mathematical expression or logical statement
            return 'False'
