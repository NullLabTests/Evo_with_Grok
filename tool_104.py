...
def tool(
    ...
    if remove_punctuation:
        if preserve_special_chars:
            ...
            preserved_chars = set(remove_characters) if remove_characters else set()
            result = ''.join(char for char in result if char.isalnum() or char.isspace() or char in preserved_chars)
        else:
