...
def tool(
    ...
    Args:
        ...
        lemmatize (bool): If True, perform lemmatization on the text. Default is False.
    ...
    # Lemmatize if specified (requires NLTK library)
    if lemmatize:
        try:
            import nltk
            ...
            print("Warning: NLTK library not found. Lemmatization skipped.")
