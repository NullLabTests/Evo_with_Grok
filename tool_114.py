...
def tool(
    ...
    Args:
        ...
        preserve_emoji (bool): If True, preserve emoji characters during processing. Default is False.
    ...
    if remove_punctuation:
        result = ''.join(char for char in result if char.isalnum() or char.isspace() or (preserve_emoji and is_emoji(char)))
