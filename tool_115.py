...
def tool(
    ...
    Args:
        ...
        add_prefix (Optional[str]): A string to add at the beginning of the result. Default is None.
        add_suffix (Optional[str]): A string to add at the end of the result. Default is None.
        max_length (Optional[int]): Maximum length of the result. If provided, the string will be truncated to this length.
