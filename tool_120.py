...
def tool(
    ...
    Args:
        ...
        split_into_sentences (bool): If True, split the result into a list of sentences. Default is False.
        remove_stopwords (Optional[List[str]]): A list of stopwords to remove from the text. Default is None.

    Returns:
        Union[str, List[str]]: The processed string or list of sentences according to the specified options.
    """
    ...
    # Split into sentences if specified
