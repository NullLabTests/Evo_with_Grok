...
def tool(
    ...
    Args:
        ...
        preserve_emoji (bool): If True, preserve emojis in the string. Default is False.
    ...
    # Preserve emojis if specified
    if preserve_emoji:
        # Emoji regex pattern (simplified for common emojis)
        emoji_pattern = re.compile("["
                               ...
                               "]+", flags=re.UNICODE)
        # Reinsert emojis that were removed in previous steps
        result = emoji_pattern.sub(lambda m: m.group(0), result)
