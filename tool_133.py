...
def tool(
    ...
    Args:
        ...
        add_prefix (Optional[str]): A string to add as a prefix to the result. Default is None.
        add_suffix (Optional[str]): A string to add as a suffix to the result. Default is None.
