...
def tool(
    ...
    Args:
        ...
        unicode_normalization (Optional[str]): If specified, apply Unicode normalization. 
            Options are 'NFC', 'NFD', 'NFKC', 'NFKD'. Default is None.
    ...
    if unicode_normalization:
        import unicodedata
        input_string = unicodedata.normalize(unicode_normalization, input_string)
