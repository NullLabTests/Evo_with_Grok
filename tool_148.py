...
def tool(
    ...
    Args:
        ...
        remove_non_ascii (bool): If True, remove non-ASCII characters from the text. Default is False.
        custom_stopwords (Optional[list]): A list of custom stopwords to remove. Default is None.
    ...
    # Apply case conversion and preserve formatting if specified
