...
def tool(
    ...
    Args:
        ...
        preserve_emojis (bool): If True, preserve emojis during text processing. Default is False.
    ...
    if preserve_formatting:
        ...
        result = ''.join(
            case_func(char) if char.isalpha() and (not preserve_emojis or not is_emoji(char)) else 
