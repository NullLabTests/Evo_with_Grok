...
def tool(input_string, case='lower', remove_punctuation=False, trim_whitespace=True, 
         ...
         custom_replacements=None, preserve_case=False):
    """
    ...
    preserve_case (bool): If True, preserve the original case of the input string. Default is False.

    Returns:
    str: The processed string according to the specified options.
    """
    # Preserve the original case if specified
    if preserve_case:
        result = input_string
    else:
