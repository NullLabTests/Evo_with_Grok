...
def tool(input_string, case='lower', remove_punctuation=False, trim_whitespace=True, 
         ...
         custom_replacements=None, preserve_formatting=False, remove_stopwords=False,
         lemmatize=False, stem=False):
    """
    Process the input string with various text manipulation and NLP options.
    ...
    stem (bool): If True, apply stemming to the text. Default is False.
