...
def tool(input_string, case='lower', remove_punctuation=False, trim_whitespace=True, 
         ...
         preserve_special_chars=False, max_length=None):
    """
    ...
    preserve_formatting (bool): If True, apply case conversion and replacements while preserving original formatting.
                                Default is False.
    preserve_special_chars (bool): If True, preserve specified special characters when removing punctuation.
                                   Default is False.
    ...
    if remove_punctuation:
        if preserve_special_chars:
            # Preserve specified special characters
            special_chars = set(string.punctuation) - set(preserve_special_chars)
            result = ''.join(char for char in result if char not in special_chars or char.isspace())
        else:
