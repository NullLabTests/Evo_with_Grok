...
def tool(input_string, case='lower', remove_punctuation=False, trim_whitespace=True, 
         ...
         custom_replacements=None, preserve_formatting=False, preserve_newlines=False):
    """
    ...
    preserve_formatting (bool): If True, apply case conversion and replacements while preserving original formatting.
                                Default is False.
    preserve_newlines (bool): If True, preserve newlines even if replace_newlines is set. Default is False.
    ...
    # Handle newlines
    if replace_newlines is not None and not preserve_newlines:
