...
def tool(
    ...
    Args:
        ...
        keep_alphanumeric (bool): If True, keep only alphanumeric characters and spaces. Default is False.
    ...
    # Keep only alphanumeric characters and spaces if specified
