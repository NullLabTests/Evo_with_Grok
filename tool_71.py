...
def tool(
    ...
    Args:
        ...
        preserve_acronyms (bool): If True, preserve the case of acronyms when converting case. Default is False.
        emoji_handling (str): How to handle emojis. Options are 'keep', 'remove', or 'replace'. Default is 'keep'.
    ...
    if emoji_handling == 'remove':
        input_string = re.sub(r'[\U0001F600-\U0001F64F\U0001F300-\U0001F5FF\U0001F680-\U0001F6FF\U0001F1E0-\U0001F1FF]', '', input_string)
    elif emoji_handling == 'replace':
        input_string = re.sub(r'[\U0001F600-\U0001F64F\U0001F300-\U0001F5FF\U0001F680-\U0001F6FF\U0001F1E0-\U0001F1FF]', '[emoji]', input_string)
    ...
    if preserve_formatting:
        ...
        # Preserve acronyms if specified
