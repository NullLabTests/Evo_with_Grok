...
def tool(
    ...
    keep_alphabet: Optional[str] = None
) -> str:
    """
    ...
    Args:
        ...
        keep_alphabet (Optional[str]): A string of characters to keep in the output. If None, keep all characters. Default is None.
    ...
    # Keep only specified characters if provided
    if keep_alphabet:
        result = ''.join(char for char in result if char in keep_alphabet)
