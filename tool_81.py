...
def tool(
    ...
    custom_replacements: Optional[Dict[str, Union[str, Callable[[str], str]]]] = None,
    ...
    Args:
        ...
        custom_replacements (Optional[Dict[str, Union[str, Callable[[str], str]]]]): A dictionary of custom replacements. 
        ...
        max_length (Optional[int]): If specified, truncate the result to this length. Default is None.
        prefix (Optional[str]): If specified, add this prefix to the result. Default is None.
        suffix (Optional[str]): If specified, add this suffix to the result. Default is None.
