...
def tool(
    ...
    Args:
        ...
        remove_non_ascii (bool): If True, remove all non-ASCII characters. Default is False.
        normalize_whitespace (bool): If True, replace all whitespace with a single space. Default is False.
