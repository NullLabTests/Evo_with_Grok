...
def tool(
    ...
    Args:
        ...
        preserve_acronyms (bool): If True, preserve acronyms when applying case conversion. Default is False.
    ...
    if preserve_formatting:
        ...
        if preserve_acronyms and case == 'lower':
            result = re.sub(r'\b([A-Z][A-Z0-9]+)\b', lambda m: m.group(1), result)
