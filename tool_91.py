...
def tool(
    ...
    Args:
        ...
        preserve_newlines (bool): If True, preserve newlines when applying case conversion. Default is False.
    ...
    if preserve_formatting:
        ...
        if preserve_newlines:
            result = '\n'.join(case_func(line) for line in input_string.split('\n'))
        else:
    ...
    if remove_characters:
        result = result.translate(str.maketrans('', '', remove_characters))
