...
def tool(
    ...
    Args:
        ...
        keep_alphabetic (bool): If True, keep only alphabetic characters in the result. Default is False.
    ...
    # Keep only alphabetic characters if specified
    if keep_alphabetic:
