...
def tool(
    ...
    keep_characters: Optional[str] = None
) -> str:
    """
    ...
    Args:
        ...
        keep_characters (Optional[str]): A string of characters to keep in the input. Default is None.
    ...
    if keep_characters:
        result = ''.join(char for char in result if char in keep_characters)
