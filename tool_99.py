...
def tool(
    ...
    Args:
        ...
        preserve_line_breaks (bool): If True, preserve line breaks when applying other transformations. Default is False.
    ...
    if replace_newlines is not None and not preserve_line_breaks:
